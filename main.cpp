 ...
 */
extern std::pair<std::string, std::string> parse_command_line(int argc, char** argv);
...
std::pair<std::string, std::string> parse_command_line(int argc, char** argv)
{
   ...
   desc.add_options()("help,h", "spell checker (correct words by finding them in the dictionary)")
