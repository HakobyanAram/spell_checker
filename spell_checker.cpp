...
spell_checker::spell_checker(const std::string& ifname, const std::string& ofname):
 _ifname(ifname),
 _ofname(ofname) { }
 ...
 for (word_data& item_word: _dictionary)
 {
  ...
  for (word_data& item_dict_word: _misspelled_words)
  {
   ...
   if (level > 0)
   {
    ...
    std::set_intersection(item_word._projections1.begin(), item_word._projections1.end(), self_v.begin(), self_v.end(), std::back_inserter(intersection));
    ...
    std::set_intersection(item_dict_word._projections1.begin(), item_dict_word._projections1.end(), self_v.begin(), self_v.end(), std::back_inserter(intersection));
   ...
   if (level > 1)
   {
    ...
    std::set_intersection(item_word._projections2.begin(), item_word._projections2.end(), self_v.begin(), self_v.end(), std::back_inserter(intersection));
    ...
    std::set_intersection(item_dict_word._projections2.begin(), item_dict_word._projections2.end(), self_v.begin(), self_v.end(), std::back_inserter(intersection));
   ...
   if (level > 1)
   {
    ...
    std::set_intersection(item_dict_word._projections1.begin(), item_dict_word._projections1.end(), item_word._projections1.begin(), item_word._projections1.end(), std::back_inserter(intersection));
...
void spell_checker::write_new_data()
{
 ...
 for (const word_data& w_item: _dictionary)
 {
  ...
  else
  {
   ...
   std::for_each(w_item._corrections.begin(), w_item._corrections.end(), [&w_item, &os_items](const std::string& item)
   {
    os_items << item;
