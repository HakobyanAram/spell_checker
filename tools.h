...
namespace ns_tools
{
   ...
   inline std::string get_current_time_str()
   {
      ...
      char date[64];
      sprintf(date, "%04u-%02u-%02u %02u:%02u:%02u.%03u", (t.tm_year + 1900), t.tm_mon + 1, t.tm_mday, t.tm_hour,
              t.tm_min, t.tm_sec, (static_cast<unsigned>(tp / std::chrono::milliseconds(1))));
